...
public class DevProfileActivity extends AppCompatActivity implements  LoaderManager.LoaderCallbacks<com.example.android.lagos_java_developers.model.DeveloperProfile> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        htmlLink = getIntent().getStringExtra("devHtmlUrl");
    ...
    private  void updateUi(com.example.android.lagos_java_developers.model.DeveloperProfile devProfile){
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        TextView developers_Actual_Name = (TextView) findViewById(R.id.full_name);
        developers_Actual_Name.setText(check(devProfile.getDevelopersName()));
    ...
    @Override
    public Loader<com.example.android.lagos_java_developers.model.DeveloperProfile> onCreateLoader(int id, Bundle args) {

        return new AsyncTaskLoader<com.example.android.lagos_java_developers.model.DeveloperProfile>(this) {
            ...
            @Override
            public com.example.android.lagos_java_developers.model.DeveloperProfile loadInBackground() {
    ...
    @Override
    public void onLoadFinished(Loader<com.example.android.lagos_java_developers.model.DeveloperProfile> loader, com.example.android.lagos_java_developers.model.DeveloperProfile data) {
        if (data == null) {
            loading.setVisibility(View.VISIBLE);
    ...
    @Override
    public void onLoaderReset(Loader<com.example.android.lagos_java_developers.model.DeveloperProfile> loader) {
